<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageUser.master" AutoEventWireup="true" CodeFile="addratingemployer.aspx.cs" Inherits="addratingemployer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row heading">
        <h2>Rating & Comment for Project # 
            <asp:Label ID="Label1" runat="server" class="form-control" Enabled="false" /></h2>
