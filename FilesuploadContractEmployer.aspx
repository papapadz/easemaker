<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEmployer.master" AutoEventWireup="true" CodeFile="FilesuploadContractEmployer.aspx.cs" Inherits="FilesuploadContractEmployer" %>
        ...
        <div class="container">
            ...
            <div class="companies">
                <div class="row heading">
                    <h2>Employer Contract Upload</h2>
                ...
                <div class="container">
                    <div class="card">
                        <fieldset class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="control-label">Employeer Contract Upload</label>
                                <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group">
                                       <%-- <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>--%>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                <label class="control-label">Freelancer Contract File</label>
                                <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group">
                                        <%--<span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>--%>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 inputGroupContainer">
                                    ...
                                    <asp:Button ID="Button1" runat="server" class="btn btn-success"
                                        Text="Approve" OnClick="Button1_Click1" />
