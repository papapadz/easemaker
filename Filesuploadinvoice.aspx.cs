...
public partial class Filesupload : System.Web.UI.Page
{
    ...
    void getexperience()
    {
        ...
        cmd.Connection = con;
        cmd.CommandText = "Select * from uploadfileinvoice where jobid=@jobid";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Delete")
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText = "DELETE uploadfileinvoice FROM uploadfileinvoice WHERE uploadfileid=@uploadfileid ";
    ...
    void AddExp()
    {
        ...
        //    }
            ...
            cmd3.Connection = con;
            cmd3.CommandText = "SELECT * FROM uploadfileinvoice " +
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "INSERT INTO uploadfileinvoice (FileName,FileDescription,jobid,DateAdded,UserID) VALUES (@FileName,@FileDescription,@jobid, @DateAdded,@UserID)";
